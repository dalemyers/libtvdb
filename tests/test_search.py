...
def test_search_show_empty_string(tvdb_client):
    """Test that searching with empty string returns empty list."""
    assert tvdb_client.search_show("") == []


def test_search_show_none(tvdb_client):
    """Test that searching with None returns empty list."""
    assert tvdb_client.search_show(None) == []
