...
def parse_date(input_string: str) -> datetime.date:
    ...
    if len(components) != 3:
        raise ValueError("The input string should be of the format YYY-MM-DD.")

    for component in components:
        try:
            _ = int(component)
        except ValueError:
            raise ValueError("The input string should be of the format YYY-MM-DD, where each date component is an integer.")
